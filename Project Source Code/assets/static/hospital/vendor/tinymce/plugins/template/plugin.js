...
(function () {
    ...
    const getPreviewContent = (editor, html) => {
      ...
      if (html.indexOf('<html>') === -1) {
        ...
        html = '<!DOCTYPE html>' + '<html>' + '<head>' + '<base href="' + encode(editor.documentBaseURI.getURI()) + '">' + contentCssEntries + preventClicksOnLinksScript + '</head>' + '<body class="' + encode(bodyClass) + '"' + dirAttr + '>' + html + '</body>' + '<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
